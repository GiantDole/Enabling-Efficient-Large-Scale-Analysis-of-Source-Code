...
public class ImportDeclarationImpl extends VertexImpl implements de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Element, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ImportDeclaration, de.uni_koblenz.jgralab.Vertex {
	...
	public ImportDeclarationImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ImportDeclaration.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ImportDeclaration.class;
	}
	...
	public <T> T getAttribute(String attributeName) {
		...
		if (attributeName.equals("onDemand")) return (T) (java.lang.Boolean) is_onDemand();
		if (attributeName.equals("static")) return (T) (java.lang.Boolean) is_static();
		throw new NoSuchAttributeException("ImportDeclaration doesn't contain an attribute " + attributeName);
	}
	...
	public <T> void setAttribute(String attributeName, T data) {
		...
		if (attributeName.equals("onDemand")) {
			set_onDemand((java.lang.Boolean) data);
			return;
		}
		if (attributeName.equals("static")) {
			set_static((java.lang.Boolean) data);
			return;
		}
		throw new NoSuchAttributeException("ImportDeclaration doesn't contain an attribute " + attributeName);
	}
	...
	public void set_onDemand(boolean _onDemand) {
		graph.fireBeforeChangeAttribute(this, "onDemand", this._onDemand, _onDemand);
		Object oldValue = this._onDemand;
		this._onDemand = _onDemand;
		internalMarkAttributeAsSet(2, true);
		graphModified();
		graph.fireAfterChangeAttribute(this, "onDemand", oldValue, _onDemand);
	}
	...
	public void set_static(boolean _static) {
		graph.fireBeforeChangeAttribute(this, "static", this._static, _static);
		Object oldValue = this._static;
		this._static = _static;
		internalMarkAttributeAsSet(3, true);
		graphModified();
		graph.fireAfterChangeAttribute(this, "static", oldValue, _static);
	}
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		...
		}
		{
			boolean attrIsSet = true;
			if (!io.isNextToken(de.uni_koblenz.jgralab.impl.TgLexer.Token.UNSET_LITERAL)) {
				_onDemand = io.matchBoolean();
			} else {
				io.match();
				attrIsSet = false;
			}
			if (attrIsSet) {set_onDemand(_onDemand);}
		}
		{
			boolean attrIsSet = true;
			if (!io.isNextToken(de.uni_koblenz.jgralab.impl.TgLexer.Token.UNSET_LITERAL)) {
				_static = io.matchBoolean();
			} else {
				io.match();
				attrIsSet = false;
			}
			if (attrIsSet) {set_static(_static);}
		}
	}
	...
	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		...
		if (isUnsetAttribute("onDemand")) {
			io.writeIdentifier(GraphIO.UNSET_LITERAL);
		} else {
			io.writeBoolean(_onDemand);
		}
		if (isUnsetAttribute("static")) {
			io.writeIdentifier(GraphIO.UNSET_LITERAL);
		} else {
			io.writeBoolean(_static);
		}
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ImportDeclaration getNextImportDeclaration() {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ImportDeclaration)getNextVertex(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ImportDeclaration.VC);
	}
