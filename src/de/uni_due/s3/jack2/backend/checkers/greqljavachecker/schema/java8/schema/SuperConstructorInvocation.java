...
public interface SuperConstructorInvocation extends de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Statement, de.uni_koblenz.jgralab.Vertex {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Java8Schema.instance().getGraphClass().getVertexClass("SuperConstructorInvocation");
	...
	/**
	 * @return the next de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocation vertex in the global vertex sequence
	 */
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationTypeArguments getFirstSuperConstructorInvocationTypeArgumentsIncidence(EdgeDirection orientation);
		 ...
		 * <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationTypeArguments</code> edge from this vertex to the given 
		 * one and returns the created edge.
		 * @return  a newly created edge of type <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationTypeArguments</code>
		 ...
		 * deleting the <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationTypeArguments</code> edges of this vertex to 
		 ...
		 * deletes the <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationTypeArguments</code> edge connections of this vertex with 
		 * the given one.
		 */
		 ...
		 *         (connected with a <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationTypeArguments</code> edge).
		 */
		 ...
		 * <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationArgument</code> edge from this vertex to the given 
		 * one and returns the created edge.
		 * @return  a newly created edge of type <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationArgument</code>
		 *          between this vertex and the given one.
		 */
		 ...
		 * deleting the <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationArgument</code> edges of this vertex to 
		 * all other ones, but doesn't delete those vertices.
		 *
		 * @return the adjacent vertices prior to removal of incidences
		 */
		 ...
		 * deletes the <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationArgument</code> edge connections of this vertex with 
		 * the given one.
		 */
		 ...
		 *         (connected with a <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SuperConstructorInvocationArgument</code> edge).
		 */
