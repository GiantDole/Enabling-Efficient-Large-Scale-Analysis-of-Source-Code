...
public class WhileStatementImpl extends VertexImpl implements de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Statement, de.uni_koblenz.jgralab.Vertex, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatement {

	protected int _line;

	public WhileStatementImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatement.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatement.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("line")) return (T) (java.lang.Integer) get_line();
		throw new NoSuchAttributeException("WhileStatement doesn't contain an attribute " + attributeName);
	}
	...
	@Override
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatement getNextWhileStatement() {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatement)getNextVertex(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatement.VC);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ForStatementBody getFirstForStatementBodyIncidence(EdgeDirection orientation) {
		...
		@Override
		public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatementBody add_body(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Statement vertex) {
			return ((de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Java8)getGraph()).createEdge(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatementBody.EC, (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatement) this, (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Statement) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Statement> remove_body() {
			...
			de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatementBody edge = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatementBody) getFirstIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatementBody.EC, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatementBody next = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatementBody) edge.getNextIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.WhileStatementBody.EC, EdgeDirection.OUT);
