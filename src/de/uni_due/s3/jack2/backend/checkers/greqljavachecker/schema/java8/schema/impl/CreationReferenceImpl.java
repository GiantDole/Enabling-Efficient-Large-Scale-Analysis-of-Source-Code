...
public class CreationReferenceImpl extends VertexImpl implements de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReference, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.MethodReference, de.uni_koblenz.jgralab.Vertex {

	protected int _line;

	public CreationReferenceImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReference.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReference.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("line")) return (T) (java.lang.Integer) get_line();
		throw new NoSuchAttributeException("CreationReference doesn't contain an attribute " + attributeName);
	}
	...
	@Override
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReference getNextCreationReference() {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReference)getNextVertex(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReference.VC);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ClassInstanceCreationArguments getFirstClassInstanceCreationArgumentsIncidence(EdgeDirection orientation) {
		...
		@Override
		public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceType add_type(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type vertex) {
			return ((de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Java8)getGraph()).createEdge(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceType.EC, (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReference) this, (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type> remove_type() {
			...
			de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceType edge = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceType) getFirstIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceType.EC, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceType next = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceType) edge.getNextIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceType.EC, EdgeDirection.OUT);
		...
		@Override
		public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments add_typeArguments(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type vertex) {
			return ((de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Java8)getGraph()).createEdge(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments.EC, (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReference) this, (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type> remove_typeArguments() {
			java.util.List<de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type> adjacences = new java.util.ArrayList<>();
			de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments edge = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments) getFirstIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments.EC, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments next = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments) edge.getNextIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments.EC, EdgeDirection.OUT);
				adjacences.add((de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type) edge.getThat());
				edge.delete();
				edge = next;
			}
		...
		public <V extends de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type> Iterable<V> get_typeArguments() {
			return new de.uni_koblenz.jgralab.impl.NeighbourIterable<de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments, V>(this, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments.EC, EdgeDirection.OUT, null);
		}
		...
		public <V extends de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type> Iterable<V> get_typeArguments(de.uni_koblenz.jgralab.VertexFilter<V> filter) {
			return new de.uni_koblenz.jgralab.impl.NeighbourIterable<de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments, V>(this, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.CreationReferenceTypeArguments.EC, EdgeDirection.OUT, filter);
		}
