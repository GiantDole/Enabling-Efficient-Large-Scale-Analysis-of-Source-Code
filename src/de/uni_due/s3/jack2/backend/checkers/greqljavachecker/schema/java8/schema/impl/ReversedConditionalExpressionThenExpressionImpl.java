...
public class ReversedConditionalExpressionThenExpressionImpl extends ReversedEdgeImpl implements de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Child, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ConditionalExpressionThenExpression, de.uni_koblenz.jgralab.Edge {
	...
	public int get_position() {
		return ((de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ConditionalExpressionThenExpression)normalEdge).get_position();
	}

	public void set_position(int _position) {
		((de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ConditionalExpressionThenExpression)normalEdge).set_position(_position);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ConditionalExpressionThenExpression getNextConditionalExpressionThenExpressionInGraph() {
		return ((de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ConditionalExpressionThenExpression)normalEdge).getNextConditionalExpressionThenExpressionInGraph();
	}
