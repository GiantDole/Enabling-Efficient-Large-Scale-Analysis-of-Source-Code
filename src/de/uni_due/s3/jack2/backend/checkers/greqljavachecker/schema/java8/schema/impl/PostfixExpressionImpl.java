...
public class PostfixExpressionImpl extends VertexImpl implements de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Expression, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpression, de.uni_koblenz.jgralab.Vertex {

	protected int _line;

	protected java.lang.String _name;

	public PostfixExpressionImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpression.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpression.class;
	}
	...
	public <T> T getAttribute(String attributeName) {
		...
		throw new NoSuchAttributeException("PostfixExpression doesn't contain an attribute " + attributeName);
	}
	...
	@Override
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpression getNextPostfixExpression() {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpression)getNextVertex(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpression.VC);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ClassInstanceCreationArguments getFirstClassInstanceCreationArgumentsIncidence(EdgeDirection orientation) {
		...
		@Override
		public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand add_operand(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SimpleName vertex) {
			return ((de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Java8)getGraph()).createEdge(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand.EC, (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpression) this, (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SimpleName) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SimpleName> remove_operand() {
			...
			de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand edge = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand) getFirstIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand.EC, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand next = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand) edge.getNextIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand.EC, EdgeDirection.OUT);
		...
		@Override
		public boolean remove_operand(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SimpleName vertex) {
		...
		@Override
		public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SimpleName get_operand() {
			de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand edge = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand) getFirstIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand.EC, EdgeDirection.OUT);
			if (edge != null) {
