...
import de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpression;
import de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SimpleName;
import de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.impl.ReversedPostfixExpressionOperandImpl;
...
/**
 * FromVertexClass: PostfixExpression
 * FromRoleName : 
 * ToVertexClass: SimpleName
 * ToRoleName : operand
 */

public class PostfixExpressionOperandImpl extends EdgeImpl implements de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Child, de.uni_koblenz.jgralab.Edge, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand {

	protected int _position;

	public PostfixExpressionOperandImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("position")) return (T) (java.lang.Integer) get_position();
		throw new NoSuchAttributeException("PostfixExpressionOperand doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand getNextPostfixExpressionOperandInGraph() {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand)getNextEdge(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand.EC);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand getNextPostfixExpressionOperandIncidence() {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand)getNextIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand.EC);
	}

	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand getNextPostfixExpressionOperandIncidence(EdgeDirection orientation) {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand)getNextIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.PostfixExpressionOperand.EC, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedPostfixExpressionOperandImpl(this, graph);
	}
	public PostfixExpression getAlpha() {
		return (PostfixExpression) super.getAlpha();
	}
