...
public interface MarkerAnnotation extends de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Annotation, de.uni_koblenz.jgralab.Vertex {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Java8Schema.instance().getGraphClass().getVertexClass("MarkerAnnotation");
	...
	/**
	 * @return the next de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.MarkerAnnotation vertex in the global vertex sequence
	 */
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.MarkerAnnotationTypeName getFirstMarkerAnnotationTypeNameIncidence(EdgeDirection orientation);
		 ...
		 * <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.MarkerAnnotationTypeName</code> edge from this vertex to the given 
		 * one and returns the created edge.
		 * @return  a newly created edge of type <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.MarkerAnnotationTypeName</code>
		 *          between this vertex and the given one.
		 */
		 ...
		 * deleting the <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.MarkerAnnotationTypeName</code> edges of this vertex to 
		 * all other ones, but doesn't delete those vertices.
		 *
		 * @return the adjacent vertices prior to removal of incidences
		 */
		 ...
		 * deletes the <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.MarkerAnnotationTypeName</code> edge connections of this vertex with 
		 * the given one.
		 */
		...
		/**
		 * @return an Iterable of all vertices adjacent to this one with the rolename 'typeName'
		 *         (connected with a <code>de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.MarkerAnnotationTypeName</code> edge).
		 */
