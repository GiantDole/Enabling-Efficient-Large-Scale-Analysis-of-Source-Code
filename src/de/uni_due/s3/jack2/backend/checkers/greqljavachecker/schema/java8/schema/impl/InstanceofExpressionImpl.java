...
public class InstanceofExpressionImpl extends VertexImpl implements de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Expression, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpression, de.uni_koblenz.jgralab.Vertex {

	protected int _line;

	public InstanceofExpressionImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpression.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpression.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("line")) return (T) (java.lang.Integer) get_line();
		throw new NoSuchAttributeException("InstanceofExpression doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpression getNextInstanceofExpression() {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpression)getNextVertex(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpression.VC);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ClassInstanceCreationArguments getFirstClassInstanceCreationArgumentsIncidence(EdgeDirection orientation) {
		...
		public java.util.List<? extends de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type> remove_rightOperand() {
			...
			de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpressionRightOperand edge = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpressionRightOperand) getFirstIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpressionRightOperand.EC, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpressionRightOperand next = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpressionRightOperand) edge.getNextIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.InstanceofExpressionRightOperand.EC, EdgeDirection.OUT);
