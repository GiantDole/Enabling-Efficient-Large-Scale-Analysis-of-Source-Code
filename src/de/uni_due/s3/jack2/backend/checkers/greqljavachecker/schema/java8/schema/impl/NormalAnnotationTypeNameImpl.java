...
import de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.impl.ReversedNormalAnnotationTypeNameImpl;
...
public class NormalAnnotationTypeNameImpl extends EdgeImpl implements de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Child, de.uni_koblenz.jgralab.Edge, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NormalAnnotationTypeName {

	protected int _position;

	public NormalAnnotationTypeNameImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NormalAnnotationTypeName.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NormalAnnotationTypeName.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("position")) return (T) (java.lang.Integer) get_position();
		throw new NoSuchAttributeException("NormalAnnotationTypeName doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NormalAnnotationTypeName getNextNormalAnnotationTypeNameInGraph() {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NormalAnnotationTypeName)getNextEdge(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NormalAnnotationTypeName.EC);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedNormalAnnotationTypeNameImpl(this, graph);
	}
