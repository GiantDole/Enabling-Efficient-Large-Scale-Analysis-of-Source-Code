...
public class ParameterizedTypeImpl extends VertexImpl implements de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedType, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type, de.uni_koblenz.jgralab.Vertex {

	protected int _line;

	protected java.lang.String _name;

	public ParameterizedTypeImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedType.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedType.class;
	}
	...
	public <T> T getAttribute(String attributeName) {
		...
		throw new NoSuchAttributeException("ParameterizedType doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedType getNextParameterizedType() {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedType)getNextVertex(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedType.VC);
	}
	...
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.TypeDeclarationSuperInterfaceTypes getFirstTypeDeclarationSuperInterfaceTypesIncidence(EdgeDirection orientation) {
		...
		public <V extends de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.Type> Iterable<V> get_typeArguments() {
			return new de.uni_koblenz.jgralab.impl.NeighbourIterable<de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedTypeTypeArguments, V>(this, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedTypeTypeArguments.EC, EdgeDirection.OUT, null);
		}
		...
		public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SimpleType get_type() {
			de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedTypeType edge = (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedTypeType) getFirstIncidence(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.ParameterizedTypeType.EC, EdgeDirection.OUT);
			if (edge != null) {
				return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.SimpleType) edge.getThat();
			}
			return null;
		}
		@Override
