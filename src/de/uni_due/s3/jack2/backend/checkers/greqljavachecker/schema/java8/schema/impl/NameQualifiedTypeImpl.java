...
public class NameQualifiedTypeImpl extends VertexImpl implements de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.AnnotatableType, de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NameQualifiedType, de.uni_koblenz.jgralab.Vertex {

	protected int _line;

	protected java.lang.String _name;

	public NameQualifiedTypeImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NameQualifiedType.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NameQualifiedType.class;
	}
	...
	public <T> T getAttribute(String attributeName) {
		...
		throw new NoSuchAttributeException("NameQualifiedType doesn't contain an attribute " + attributeName);
	}
	...
	@Override
	public de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NameQualifiedType getNextNameQualifiedType() {
		return (de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NameQualifiedType)getNextVertex(de.uni_due.s3.jack2.backend.checkers.greqljavachecker.schema.java8.schema.NameQualifiedType.VC);
	}
