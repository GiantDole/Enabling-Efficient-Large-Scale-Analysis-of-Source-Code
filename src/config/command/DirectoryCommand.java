...
import config.DirectoryTreeConstructor;
...
public class DirectoryCommand implements Command{
	...
	public DirectoryCommand() {
		...
		excludes = new ArrayList<ExcludeCommand>();
	}
	...
	public void executeCommand(Config config) {
		...
		DirectoryTreeConstructor constructor = new DirectoryTreeConstructor(nodes, excludes);
		constructor.constructTree(config);
//		NodeCommand firstC = nodes.element();
//		String path = firstC.getPath();
//		File firstFile = new File(path);
//		firstDirectory = new TopDirectory(firstFile);
//		firstC.setPath("");
//		
